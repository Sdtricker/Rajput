...
# --- Page Serving Routes (Specific pehle) ---
@app.route('/')
...
def search():
    ...
    try:
        ...
        data = load_data(); data["users"][ip]["credits"] += CREDIT_COST; save_data(data)
...
# --- Static File Handler (Generic, sabse neeche rakho) ---
@app.route('/<path:filename>')
def serve_static(filename):
    # Security: Don't serve files without extension or with blacklisted extensions
